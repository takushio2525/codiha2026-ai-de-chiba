...
<img src="img/18-hazard-legend-pc.jpg" alt="ハザードのトグル 4 つ、不透明度スライダー、洪水の 6 段階の凡例、注意書き" width="100%">

その下に**凡例**が出る。**洪水は 6 段階、津波・高潮は 8 段階**で、同じ色でも表す深さが違う。
**土砂災害だけは深さではなく区域の種別**（特別警戒 / 警戒 × 指定済 / 指定予定の 4 区分）で、
青い破線で囲まれているものが「指定予定」。**表示中のものに合わせて出し分ける**ので、
2 つ以上 ON にすると凡例も 2 つ並ぶ。

<img src="img/21-hazard-landslide-pc.jpg" alt="土砂災害を ON にしたところ。洪水と土砂災害の凡例が縦に 2 つ並んでいる" width="100%">

土砂災害を ON にしたところ。**洪水の凡例の下に土砂災害の凡例が足される。**
地図では北部（国分・国府台・中山・曽谷のあたり）の斜面に区域が出る。
